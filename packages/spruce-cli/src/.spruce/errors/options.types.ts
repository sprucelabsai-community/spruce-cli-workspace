...
export interface ViewPluginAlreadyExistsErrorOptions
    extends SpruceErrors.SpruceCli.ViewPluginAlreadyExists,
        ISpruceErrorOptions {
    code: 'VIEW_PLUGIN_ALREADY_EXISTS'
}
export interface TransportAlreadyExistsErrorOptions
    extends SpruceErrors.SpruceCli.TransportAlreadyExists,
        ISpruceErrorOptions {
    code: 'TRANSPORT_ALREADY_EXISTS'
}
export interface ThemeExistsErrorOptions
    extends SpruceErrors.SpruceCli.ThemeExists,
        ISpruceErrorOptions {
    code: 'THEME_EXISTS'
}
...
export interface StoreExistsErrorOptions
    extends SpruceErrors.SpruceCli.StoreExists,
        ISpruceErrorOptions {
    code: 'STORE_EXISTS'
}
export interface SkillViewExistsErrorOptions
    extends SpruceErrors.SpruceCli.SkillViewExists,
        ISpruceErrorOptions {
...
export interface SkillNotFoundErrorOptions
    extends SpruceErrors.SpruceCli.SkillNotFound,
        ISpruceErrorOptions {
    code: 'SKILL_NOT_FOUND'
}
export interface SchemaTemplateItemBuildingFailedErrorOptions
    extends SpruceErrors.SpruceCli.SchemaTemplateItemBuildingFailed,
        ISpruceErrorOptions {
...
export interface NotLoggedInErrorOptions
    extends SpruceErrors.SpruceCli.NotLoggedIn,
        ISpruceErrorOptions {
    code: 'NOT_LOGGED_IN'
}
...
export interface NoSkillsRegisteredErrorOptions
    extends SpruceErrors.SpruceCli.NoSkillsRegistered,
        ISpruceErrorOptions {
...
export interface MissingDependenciesErrorOptions
    extends SpruceErrors.SpruceCli.MissingDependencies,
        ISpruceErrorOptions {
...
export interface InvalidEventContractErrorOptions
    extends SpruceErrors.SpruceCli.InvalidEventContract,
        ISpruceErrorOptions {
...
export interface DockerNotStartedErrorOptions
    extends SpruceErrors.SpruceCli.DockerNotStarted,
        ISpruceErrorOptions {
...
export interface DeployFailedErrorOptions
    extends SpruceErrors.SpruceCli.DeployFailed,
        ISpruceErrorOptions {
    code: 'DEPLOY_FAILED'
}
export interface DependencyExistsErrorOptions
    extends SpruceErrors.SpruceCli.DependencyExists,
        ISpruceErrorOptions {
...
export interface CommandBlockedErrorOptions
    extends SpruceErrors.SpruceCli.CommandBlocked,
        ISpruceErrorOptions {
...
export interface CacheNotEnabledErrorOptions
    extends SpruceErrors.SpruceCli.CacheNotEnabled,
        ISpruceErrorOptions {
...
export interface BootErrorErrorOptions
    extends SpruceErrors.SpruceCli.BootError,
        ISpruceErrorOptions {
    code: 'BOOT_ERROR'
}
export interface ActionCancelledErrorOptions
    extends SpruceErrors.SpruceCli.ActionCancelled,
        ISpruceErrorOptions {
...
type ErrorOptions =
    ...
    | ViewPluginAlreadyExistsErrorOptions
    | TransportAlreadyExistsErrorOptions
    | ThemeExistsErrorOptions
    | TestFailedErrorOptions
    | StoreExistsErrorOptions
    | SkillViewExistsErrorOptions
    | SkillNotRegisteredErrorOptions
    | SkillNotFoundErrorOptions
    | SchemaTemplateItemBuildingFailedErrorOptions
    | SchemaFailedToImportErrorOptions
    | SchemaExistsErrorOptions
    | NotLoggedInErrorOptions
    | NotImplementedErrorOptions
    | NoSkillsRegisteredErrorOptions
    ...
    | InvalidEventContractErrorOptions
